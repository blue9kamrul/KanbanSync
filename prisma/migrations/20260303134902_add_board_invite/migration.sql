...
-- CreateEnum
CREATE TYPE "TaskCategory" AS ENUM ('NEW_FEATURE', 'EPIC', 'STORY', 'TASK', 'SUB_TASK', 'BUG', 'ENHANCEMENT', 'PATCH', 'HOTFIX');

-- CreateEnum
CREATE TYPE "BoardRole" AS ENUM ('LEADER', 'REVIEWER', 'MEMBER');
...
-- CreateIndex
CREATE UNIQUE INDEX "board_invites_boardId_invitedEmail_key" ON "board_invites"("boardId", "invitedEmail");
...
-- AddForeignKey
ALTER TABLE "board_invites" ADD CONSTRAINT "board_invites_inviterId_fkey" FOREIGN KEY ("inviterId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "board_invites" ADD CONSTRAINT "board_invites_invitedUserId_fkey" FOREIGN KEY ("invitedUserId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
